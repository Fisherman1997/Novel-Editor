...
useAutoSave()
const { isLeftCollapsed, isRightCollapsed, toggleLeftPanel, toggleRightPanel, toggleFullscreen, exitFullscreen } = usePanelCollapse()
...
.panel-left-leave-active {
  transition: margin-left @transition-slow, opacity @transition-slow;
}
...
.panel-right-leave-active {
  transition: margin-right @transition-slow, opacity @transition-slow;
}
