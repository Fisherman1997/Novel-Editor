    ...
    <div class="settings-dialog">
      ...
      <div class="settings-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-item">
            ...
            <el-slider v-model="localSettings.lineHeight" :min="22" :max="42" :step="1" />
          </div>

          <div class="form-item">
            <label>文字颜色</label>
            <el-input v-model="localSettings.fontColor" placeholder="#1f2328" maxlength="7" />
          </div>

          <div class="form-item">
            <label>背景颜色</label>
            <el-input v-model="localSettings.backgroundColor" placeholder="#ffffff" maxlength="7" />
          </div>

          <div class="form-item">
            <label>右侧面板宽度 {{ localSettings.rightPanelWidth }}px</label>
            <el-slider v-model="localSettings.rightPanelWidth" :min="220" :max="480" :step="10" />
          </div>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div class="form-grid form-grid-2">
          ...
          <div class="form-item" v-if="localAutoSave.enabled">
            <label>保存间隔 {{ localAutoSaveInterval }} 秒</label>
            <el-slider v-model="localAutoSaveInterval" :min="10" :max="300" :step="10" />
          </div>
          <div class="form-item" v-if="localAutoSave.enabled">
            <label>编辑后静默保存延迟 {{ Math.round(localAutoSave.delay / 1000) }} 秒</label>
      ...
      <div class="settings-section">
        ...
        <div class="data-management">
          <button class="danger-action" @click="clearCache">
            清除所有本地缓存
          </button>
