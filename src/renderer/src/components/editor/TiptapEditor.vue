<template>
  <div class="tiptap-editor">
    ...
    <div class="editor-scroll" ref="editorContentRef" @click="focusEditor">
    ...
    <div class="editor-statusbar">
      ...
      <div class="statusbar-right">
        ...
        <el-tooltip content="章节目录 (Ctrl+\)" placement="top" :show-after="400">
          <button class="icon-btn" :class="{ 'is-active': !isLeftCollapsed }" @click="toggleLeftPanel">
            <AppIcon name="panel-left" :size="14" />
          </button>
        </el-tooltip>
        <el-tooltip content="素材面板 (Ctrl+Shift+H)" placement="top" :show-after="400">
          <button class="icon-btn" :class="{ 'is-active': !isRightCollapsed }" @click="toggleRightPanel">
            <AppIcon name="panel-right" :size="14" />
          </button>
        </el-tooltip>
        <el-tooltip :content="isFullscreen ? '退出沉浸模式 (Esc)' : '沉浸模式 (Ctrl+Shift+E)'" placement="top" :show-after="400">
          <button class="icon-btn" :class="{ 'is-active': isFullscreen }" @click="toggleFullscreen">
...
const { isLeftCollapsed, isRightCollapsed, isFullscreen, toggleLeftPanel, toggleRightPanel, toggleFullscreen } = usePanelCollapse()
...
watch(
  ...
  async (scroll) => {
    ...
    if (container && coords) {
      ...
      const targetY = coords.top - containerRect.top + container.scrollTop - containerRect.height / 3
