<template>
    <div class="character-list">
        ...
        <div v-if="novelStore.characters.length > 0" class="list-content">
            <div
            ...
            >
                ...
                <div class="character-info">
                    ...
                    <div v-if="character.personality" class="character-personality text-ellipsis">
        ...
        <div v-if="selectedCharacter" class="character-detail">
            ...
            <div class="detail-form">
                ...
                <div class="form-item">
                    <label>详细描述</label>
                    <el-input
                        v-model="selectedCharacter.content"
                        type="textarea"
                        :rows="4"
                        placeholder="人物背景、经历、目标..."
                    />
                </div>
            </div>
        </div>
