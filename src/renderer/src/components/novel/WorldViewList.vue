<template>
    <div class="worldview-list">
        ...
        <div v-if="novelStore.worldViews.length > 0" class="list-content">
            <div
            ...
            >
                ...
                <div class="worldview-info">
                    ...
                    <div v-if="worldView.content" class="worldview-preview text-ellipsis">
                        {{ worldView.content }}
                    </div>
                    <div v-else-if="worldView.settings.length > 0" class="worldview-tags">
                        <span
                            v-for="(setting, sIndex) in worldView.settings.slice(0, 3)"
                            :key="sIndex"
                            class="tag"
                        >
                            {{ setting }}
                ...
                <button
                    class="icon-btn is-danger item-delete"
                    title="删除"
                    @click.stop="deleteWorldView(index)"
                >
            ...
            <div class="detail-form">
                ...
                <div class="form-item">
                    ...
                    <div class="settings-list">
                        ...
                        >
                            <el-input
                                v-model="selectedWorldView.settings[sIndex]"
                                size="small"
                                placeholder="设定要点"
                            />
                            <button
                                class="icon-btn is-danger remove-btn"
                                @click="removeSetting(sIndex)"
                            >
...
const { dragState, onDragStart, onDragOver, onDragLeave, onDrop, onDragEnd } = useDragSort(
    (from, to) => {
